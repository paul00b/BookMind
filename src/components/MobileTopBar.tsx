...
export default function MobileTopBar({ onOpenSettings }: Props) {
  ...
  return (
    <header className="md:hidden flex items-center justify-between px-4 py-3 bg-white/85 dark:bg-[#1a1f2e]/85 backdrop-blur-xl sticky top-0 z-20" style={{ paddingTop: 'max(12px, env(safe-area-inset-top))' }}>
